  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 text-center px-4 max-w-4xl mx-auto py-8">
        ...
        <h1 className="font-montserrat font-bold text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-salon-teal mb-4 md:mb-6 animate-fade-in leading-tight" style={{ animationDelay: '0.1s' }}>
          <span className="block">{t('hero.title')}</span>
          <span className="block text-salon-teal-light mt-2">{t('hero.subtitle')}</span>
        </h1>
        
        <p className="font-lora text-base sm:text-lg md:text-xl lg:text-2xl text-gray-700 mb-6 md:mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in px-2" style={{ animationDelay: '0.3s' }}>
          {t('hero.description')}
        </p>

        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in px-4" style={{ animationDelay: '0.5s' }}>
          <Button
