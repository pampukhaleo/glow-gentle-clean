          ...
          <div className="bg-white rounded-2xl shadow-lg p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="font-lora text-gray-700 mb-2 block">Name *</label>
                  <Input
                    type="text"
                    name="name"
                    value={formData.name}
                ...
                <div>
                  <label className="font-lora text-gray-700 mb-2 block">Telefon *</label>
                  <Input
                    type="tel"
                    name="phone"
              ...
              <div>
                <label className="font-lora text-gray-700 mb-2 block">E-Mail</label>
                <Input
                  type="email"
                  name="email"
              ...
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <label className="font-lora text-gray-700 mb-2 block">Gewünschte Behandlung</label>
                  <select
                    name="service"
                ...
                <div>
                  <label className="font-lora text-gray-700 mb-2 block">Wunschtermin</label>
                  <Input
                    type="date"
                    name="date"
                    value={formData.date}
              ...
              <div>
                <label className="font-lora text-gray-700 mb-2 block">Nachricht</label>
                <Textarea
                  name="message"
