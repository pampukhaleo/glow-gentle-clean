...
const translations = {
  de: {
    ...
    'contact.hours.detail': 'Mo-Fr: 10:00 - 19:00\nSa: 9:00 - 17:00\nSo: Geschlossen',
    'contact.footer.tagline': 'Professionelle Laser-Haarentfernung in Krefeld',
  ...
  uk: {
    ...
    'contact.hours.detail': 'Пн-Пт: 10:00 - 19:00\nСб: 9:00 - 17:00\nНд: Зачинено',
    'contact.footer.tagline': 'Професійна лазерна епіляція в Krefeld',
